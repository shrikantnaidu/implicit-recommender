"""Script to serve the trained model as a FastAPI application."""
import os
import uvicorn
...
# Import ALSModel for type hints
from typing import Optional

# Import ALSModel for type hints
from implicit_vibecode.models.als_model import ALSModel  # noqa: F401
...
class SimilarItemsRequest(BaseModel):
    """Request model for getting similar items."""
    item_id: int
    k: int = 10
...
async def load_model():
    ...
    try:
        ...
        experiment = client.get_experiment_by_name("implicit-vibecode-demo")
        ...
        # Load metadata (in a real app, you might want to store this in MLflow)
        metadata = {
            "run_id": run_id,
...
if __name__ == "__main__":
    ...
    # Start the server
    uvicorn.run("serve_model:app", host=host, port=port, reload=True)
